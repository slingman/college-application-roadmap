...
A self-contained HTML dashboard for a Class of 2027 psychology-focused college applicant.
...
The page has no external dependencies, so it works as a simple GitHub Pages site.
